     ...
     <div className="bg-[#5800ff]  text-white">
      ...
      <div className="bg-[url('/campus360.jpg')] bg-fixed bg-cover bg-center">
          ...
          <nav className="container mx-auto p-4 flex justify-evenly items-center">
            ...
            <ul className="flex space-x-4">
                 ...
                 <li> <Link to="/" className="hover:text-gray-300">
                              ...
                              <li> <Link to="/cafeteriapage" className="hover:text-gray-300">
                              Cafeteria
                              </Link></li>
                              <li> 
                                <a href="http://192.168.1.11:3000/admintransport.html">Transport</a>
                              </li>
              ...
              {/* <li><a href="/home" className="hover:text-gray-300">Main Menu</a></li>
        ...
        <section className="h-screen flex items-center justify-center text-center">
          <div className="bg-[rgba(88,0,255,.85)]  p-10 rounded-lg animate-fade-in-up bg-opacity-50">
      ...
      <section id="services" className="container mx-auto p-10 ">
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          {[  
            ...
            <div key={service.title} className="card glass w-80">  
      ...
      <section className="container mx-auto p-10">
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          {[  
            ...
            <div key={item.title} className="card glass w-80">  
